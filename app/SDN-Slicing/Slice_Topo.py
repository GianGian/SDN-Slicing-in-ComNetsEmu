...
def myTopology():
    ...
    h8 = net.addDockerHost("h8", dimage="dev_test", ip="192.0.0.8", docker_args={"hostname": "h8"},)
    ...
    srv3 = mgr.addContainer("srv3", "h3", "eclipse-mosquitto", "bash", docker_args={},) #brocker
    srv4 = mgr.addContainer("srv4", "h4", "aksakalli/mqtt-client", "bash /home/clientnew.sh", docker_args={},)
    srv5 = mgr.addContainer("srv5", "h5", "aksakalli/mqtt-client", "bash", docker_args={},)
