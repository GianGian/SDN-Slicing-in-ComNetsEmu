...
This project is based on the https://git.comnets.net/public-repo/comnetsemu repository which was used to carry out a project which involved the creation of an SDN Slicing.
You can find it in this directory:

```bash
$ cd $TOP_DIR/comnetsemu/app/SDN-Slicing
```
The project instructions are contained in the folder, in a README file.
We reported below the installation instructions of the SW ComNetsEmu.
